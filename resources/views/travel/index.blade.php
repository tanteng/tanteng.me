                        ...
                        @foreach($destinationList as $list)
                            <div class="col-sm-6 col-md-4 box">
                                <div class="thumbnail">
                                    ...
                                    <div class="caption">
                                        <h3><a href="{{ route('travel.destination', [$list->slug]) }}">{{ $list->destination }}</a><span class="pull-right badge">@if(isset($travelNums[$list->id])) {{ $travelNums[$list->id] }} @else 0 @endif篇</span></h3>
