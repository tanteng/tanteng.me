...
@section('main_content')
    <div class="content-wrapper">
        <section class="content-header">
            <h1>添加游记<small>Add Travel Notes</small></h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" action="{{ route('travel.store') }}" method="post">
                            {{ csrf_field() }}
                            <div class="box-body">
                                ...
                                <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="slug" id="slug" placeholder="slug" value="{{ old('slug') }}" type="text">
                                    @if ($errors->has('slug'))
                                        <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="title" id="title" placeholder="标题" value="{{ old('title') }}" type="text">
                                    @if ($errors->has('title'))
                                        <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('seo_title') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="seo_title" id="seo_title" placeholder="SEO标题" value="{{ old('seo_title') }}" type="text">
                                ...
                                <div class="form-group{{ $errors->has('cover_image') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="cover_image" id="cover_image" placeholder="封面图" value="{{ old('cover_image') }}" type="text">
                                ...
                                <div class="form-group{{ $errors->has('begin_date') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="begin_date" id="begin_date" placeholder="开始时间" value="{{ old('begin_date') }}" type="text">
                                ...
                                <div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="end_date" id="end_date" placeholder="结束时间" value="{{ old('end_date') }}" type="text">
                                ...
                                <div class="form-group{{ $errors->has('score') ? ' has-error' : '' }}">
                                    ...
                                    <input class="form-control" name="score" id="score" placeholder="评分" value="{{ old('score') }}" type="text">
                                    @if ($errors->has('score'))
                                        <span class="help-block">
